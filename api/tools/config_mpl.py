...
def figsize(
    ...
    Args:
        ...
        fraction (float, optional): Fraction of the width which you wish the figure to occupy. Defaults to 1.
        subplots (tuple[int, int], optional): The number of rows and columns of subplots, by default (1, 1). Defaults to (1, 1).

    Raises:
        AssertionError: If another LaTeX class than scrbook is used.

    Returns:
        tuple[float, float]: Dimensions of figure in inches.
...
def set_up_mpl(
    ...
    Args:
        tex (bool, optional): Determine if LaTeX settings in matplotlib should be used. Defaults to False.
